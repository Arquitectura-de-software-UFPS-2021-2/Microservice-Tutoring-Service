...
public class ManejadorListarTutoriasTrue {
    ...
    public List<TutoriaSalida> list() throws NotFoundException {
        List<Tutoring> tutoriaBusqueda = tutoriaRepositorioInterface.findTutoriasTrue();
        ...
        for(Tutoring tutoria : tutoriaBusqueda)
        {
            ...
            newtutoria.setState(tutoria.isState());//Fixed
